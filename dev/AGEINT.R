...
#' 
#' @examples 
#' EarlyPop      <- c(100958, 466275, 624134, 559559, 446736, 370653, 301862, 
#' 249409, 247473, 223014, 172260, 149338, 127242, 105715, 79614, 53660, 31021, 34596)
#' LaterPop    <- c(201916, 932550, 1248268, 1119118, 893472, 741306, 603724, 
#' 498818, 494946, 446028, 344520, 298676, 254484, 211430, 159228, 107320, 62042, 69192)
