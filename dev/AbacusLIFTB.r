# TR: this appears to be a verbatim-as-possible translation
# of a version of mortpak. This handles extrapolation.
# not sure who to credit if parts of this get recycled.
# arrays and indexing abide by single ages, out to age 101 in any case.
# however, formulas are for abridged tables. Ergo, only abridged
