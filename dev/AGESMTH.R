...
#' underOnePop <- c(321476, 332782, 503070, 323460, 265534, 322576, 306329, 245883, 179182, 145572, 95590, 81715, 48412, 54572, 28581, 26733, 14778, 30300)
#' Ages <- seq(0, 80, by = 5)
#' Ages2 <- c(0,1,5,10,15,20,25,30,35,40,45,50,55,60,65,70,75,80)
#' 
...
popAgeSmth <- function(Value, Age, Method, SplitU5 = FALSE){
  if (SplitU5){
  ...
  if (Method == "Carrier-Farrag"){
    ...
    Value5PxPrime <- (1/16)*(-Value5PxMinus10 + 4*Value5PxMinus5 + 10*Value5Px + 4*Value5PxPlus5 - Value5PxMinus10)
  }
  ...
  if (Method == "Carrier-Farrag" || Method == "KKN" || Method == "Arriaga"){
    ...
    SmthPop[seq(3, length(SmthPop) - 4, by=2)] <- round(Value5Px)
    SmthPop[seq(4, length(SmthPop) - 3, by=2)] <- round(Value5PxPlus5)
    ...
    #Combine sequences and create full 5-year age group structure
    SmthPop <- rep(0, length(aggValue)/5)
    SmthPop[seq(3, length(SmthPop) - 3)] <- round(Value5PxPrime)
    ...
    #Combine sequences and create full 5-year age group structure
    SmthPop <- rep(0, length(aggValue)/5)
    SmthPop[seq(3, length(SmthPop) - 4, by=2)] <- round(Value10PxPrime/2)
    SmthPop[seq(4, length(SmthPop) - 3, by=2)] <- round(Value10PxPrime/2)
