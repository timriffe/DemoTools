...
namespace model_rc_9_namespace {
using std::istream;
using std::string;
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_rc_9");
    reader.add_event(42, 40, "end", "model_rc_9");
    return reader;
}
#include <stan_meta_header.hpp>
class model_rc_9
  : public stan::model::model_base_crtp<model_rc_9> {
private:
        int N;
        vector_d x;
        vector_d y;
public:
    model_rc_9(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_rc_9_namespace::model_rc_9";
    ...
    T__ log_prob(std::vector<T__>& params_r__,
        ...
        try {
            ...
            stan::math::assign(mu_rc, add(add(add(multiply(a1, stan::math::exp(multiply(-(alpha1), x))), multiply(a2, stan::math::exp(subtract(multiply(-(alpha2), subtract(x, mu2)), stan::math::exp(multiply(-(lambda2), subtract(x, mu2))))))), multiply(a4, stan::math::exp(multiply(lambda4, x)))), c));
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_rc_9_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
...
typedef model_rc_9_namespace::model_rc_9 stan_model;
#ifndef USING_R
