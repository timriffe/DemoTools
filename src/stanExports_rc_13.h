...
namespace model_rc_13_namespace {
using std::istream;
using std::string;
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_rc_13");
    reader.add_event(50, 48, "end", "model_rc_13");
    return reader;
}
#include <stan_meta_header.hpp>
class model_rc_13
  : public stan::model::model_base_crtp<model_rc_13> {
private:
        int N;
        vector_d x;
        vector_d y;
public:
    model_rc_13(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_rc_13_namespace::model_rc_13";
    ...
    void transform_inits(const stan::io::var_context& context__,
        ...
        pos__ = 0U;
        context__.validate_dims("parameter initialization", "a4", "double", context__.to_vec());
        double a4(0);
        a4 = vals_r__[pos__++];
        try {
            writer__.scalar_lub_unconstrain(0, 1, a4);
        } catch (const std::exception& e) {
        ...
        pos__ = 0U;
        context__.validate_dims("parameter initialization", "lambda4", "double", context__.to_vec());
        double lambda4(0);
        lambda4 = vals_r__[pos__++];
        try {
            writer__.scalar_lb_unconstrain(0, lambda4);
        } catch (const std::exception& e) {
    ...
    T__ log_prob(std::vector<T__>& params_r__,
        ...
        try {
            ...
            current_statement_begin__ = 13;
            local_scalar_t__ a4;
            (void) a4;  // dummy to suppress unused var warning
            if (jacobian__)
                a4 = in__.scalar_lub_constrain(0, 1, lp__);
            else
                a4 = in__.scalar_lub_constrain(0, 1);
            current_statement_begin__ = 14;
            local_scalar_t__ c;
            ...
            current_statement_begin__ = 19;
            local_scalar_t__ lambda4;
            (void) lambda4;  // dummy to suppress unused var warning
            if (jacobian__)
                lambda4 = in__.scalar_lb_constrain(0, lp__);
            else
                lambda4 = in__.scalar_lb_constrain(0);
            current_statement_begin__ = 20;
            ...
            stan::math::assign(mu_rc, add(add(add(add(multiply(a1, stan::math::exp(multiply(-(alpha1), x))), multiply(a2, stan::math::exp(subtract(multiply(-(alpha2), subtract(x, mu2)), stan::math::exp(multiply(-(lambda2), subtract(x, mu2))))))), multiply(a3, stan::math::exp(subtract(multiply(-(alpha3), subtract(x, mu3)), stan::math::exp(multiply(-(lambda3), subtract(x, mu3))))))), multiply(a4, stan::math::exp(multiply(lambda4, x)))), c));
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_rc_13_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
        ...
        vars__.push_back(a3);
        double a4 = in__.scalar_lub_constrain(0, 1);
        vars__.push_back(a4);
        ...
        double lambda4 = in__.scalar_lb_constrain(0);
        vars__.push_back(lambda4);
...
typedef model_rc_13_namespace::model_rc_13 stan_model;
#ifndef USING_R
