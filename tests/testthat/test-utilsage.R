...
test_that("groupAges works",{
    ...
    Age <- 0:100
    expect_equivalent(
        groupAges(India1991males, N = 5) [1:3],
        c(52360652, 57419164, 51947630)
    )
    expect_equivalent(
        groupAges(India1991males, N = 5, shiftdown = 1) [1:3],
        c(40488149, 61180144, 51043772)
    )
    expect_equivalent(
        groupAges(India1991males, N = 5, shiftdown = 2) [1:3],
        c(28606305, 58749766, 57901419)
    )
    expect_equivalent(
        groupAges(India1991males, N = 5, shiftdown = 3) [1:3],
        c(17016196, 60305957, 54630220)
    )
    expect_equivalent(
        groupAges(India1991males, N = 5, shiftdown = 4) [1:3],
        c(9544406, 55784596, 59761861)
    )
    expect_equivalent(
        tail(groupAges(India1991males, N = 5, OAnew = 80), 3),
