...
#' @examples 
#' # data from GDA1981IREDA, Table 15 and 16, page 375-376: Ghana (1970 Males + Females), population between 10 and 40 years by single age.
...
spencer <- function(Value){
  ...
  n55i<-c(NA,filter(n5i, rep(1, 5L))[-c(1, length(n5i))],NA)
  
  # n75i= The sum of the n55i population for seven consecutive ages, centered on age i
  n75i<-c(NA,filter(n55i, rep(1, 7L))[-c(1, length(n55i))],NA)
