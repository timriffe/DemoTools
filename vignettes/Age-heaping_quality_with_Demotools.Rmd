...
Several indices of age-heaping exist. `DemoTools` implements Whipple [@spoorenberg2007quality], Myers, Bachi [@bachi1951tendency], Coale-Li [@coale1991effect], Noumbissi [@noumbissi1992indice], Spoorenberg [@spoorenberg2007quality], Jdanov [@jdanov2008beyond], and Kannisto [@kannisto1999assessing] age-heaping indices.
...
```
Myers index, `r round(Myers(pop1m_ind, Age, ageMin = 20, ageMax = 90),2)` in this case, expresses the extent of concentration on or avoidance of a particular digit [@myers1954accuracy]. The theoretical range of Myers
